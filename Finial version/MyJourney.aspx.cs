...
{
   /***********************
    When the Item changed, the event will be sparked
    ***********************/
    ...
    /*Write the null string into the file*/
    ...
    *****************************/
    ...
    //Transfor the Date extact from the database convert to the JSon format
    ...
    // following function are used to the select the sppcific data from the database
    ...
    public void Wifi()
    {
        string sql = "select Latitude,Longitude,Address from Wifi";
        connectDB(sql);
    }

    //The event to handle the item when it changed 
