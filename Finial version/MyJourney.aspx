...
<head runat="server">
  ...
  $("button").click(function(){
    ...
    <!--this funtion used to chech the brower whether support the Geolocation-->
   <script type="text/javascript">
       ...
       //init(): open the new google map in the page.
       ...
       function init() {
           ...
           /*google.maps.event.addListener(map, 'click', function (mouseEvent) {
                   ...
                   icon: 'images/MarkerA1.png'
                   });
                   destination = mouseEvent.latLng;
                   usermarkers.push(usermarker);
                   DeleteMarker();
           });  */
           //add the current location in the map
       ...
       // DeleteMarker() is clear all the marker in the map
       ...
       //addMarker(): add the new marker in the google map use the data from the JSon.
       function addMarker() {
           $.ajax(
           {
               type: "GET",
               ...
               success: function (data) {
                   ...
                   for (var index in data) {
                       ...
                       {
                           contentString = '<div id="content"  style="font-weight:bold;font-color:black">' + data[index].Description + '<br/>' + '</div>';
                           //add maker
                           var marker = new google.maps.Marker({
                               position: myLatlng,
                               map: map,
                       ...
                       } else if (text == "Budget Food & Drinks venue")
                       {
                           contentString = '<div id="content" style="font-weight:bold;font-color:black">' + '<p><b>Category:</b>' + data[index].Category + '<br/>' + '<b>What:</b>' + data[index].What + '<br/>' + '<b>Who:</b>' + data[index].Who + '<br/>' + '<b>Phone:</b>' + data[index].Phone + '<br/>' + '<b>Website:</b>' + data[index].Website + '<br/></p>' + '</div>';
                           ...
                           var marker = new google.maps.Marker({
                               ...
                               animation: google.maps.Animation.G,
                               title: 'Food & Drinks venue'
                           });
                           showinfomessage(marker, index);

                       } else if (text == "Parking Pod")
                       {
                           contentString = '<div id="content" style="font-weight:bold;font-color:black">' + 'Featurename:' + data[index].Featurename + '<br/>' + 'Number of bicycle:' + data[index].NBBikes + '<br/>' + '</div>';
                               var marker = new google.maps.Marker({
                               position: myLatlng,
                               map: map,
                               icon: new google.maps.MarkerImage('images/cycling.png', undefined, undefined, undefined, new google.maps.Size(20, 20)),
                               animation: google.maps.Animation.G,
                               title: 'Parking Pod'
                           ...
                           contentString = '<div id="content" style="font-weight:bold;font-color:black">' + 'Male:' + data[index].Male + '<br/>' + 'Female:' + data[index].Female + '<br/>' + 'Disabled:' + data[index].Disabled + '<br/>' + 'Unisex:' + data[index].Unisex + '<br/>' + 'Babychange:' + data[index].Babychange + '<br/>' + '</div>';
                           var marker = new google.maps.Marker({
                               position: myLatlng,
                               map: map,
                           ...
                           var marker = new google.maps.Marker({
                               position: myLatlng,
                               map: map,
                               icon: new google.maps.MarkerImage('images/Blackpot.png', undefined, undefined, undefined, new google.maps.Size(15, 15)),
                               animation: google.maps.Animation.G ,
                           });
                           ...
                           contentString = '<div id="content" style="font-weight:bold;font-color:black">' + 'Asset Type:' + data[index]["Asset Type"] + '<br/>' + 'Artist:' + data[index].Artist + '<br/>' + 'Respective Author:' + data[index]["Respective Author"] + '<br/>' + 'Structure:' + data[index].Structure + '<br/>' + '</div>';
                           var marker = new google.maps.Marker({
                               position: myLatlng,
                               map: map,
                               icon: new google.maps.MarkerImage('images/Art1.png', undefined, undefined, undefined, new google.maps.Size(20, 20)),
                               animation: google.maps.Animation.G,
                               title: 'Public Art Works'
                           });
                           showinfomessage(marker, index);

                       }
                       else if (text == "LandMarks & Places Of Interest") {
                           contentString = '<div id="content" style="font-weight:bold;font-color:black">' + 'Theme:' + data[index].Theme + '<br/>' + 'Sub Theme:' + data[index]["Sub Theme"] + '<br/>' + 'Feature Name:' + data[index]["Feature Name"] + '<br/>' + '</div>';
                           var marker = new google.maps.Marker({
                               position: myLatlng,
                               map: map,
                           ...
                           contentString = '<div id="content" style="font-weight:bold;font-color:black">' + 'Name:' + data[index].Name + '<br/>' + 'Address:' + data[index].Address + '<br/>' + '</div>';
                           var marker = new google.maps.Marker({
                               position: myLatlng,
                               map: map,
                               icon: new google.maps.MarkerImage('images/busstop.png', undefined, undefined, undefined, new google.maps.Size(20, 20)),
                               animation: google.maps.Animation.G,
                               title: 'Visitor Shuttle Bus Stops'
                           });
                           showinfomessage(marker, index);
                       }
                       else if (text == "Free Wifi") {
                           contentString = '<div id="content" style="font-weight:bold;font-color:black">' + 'Address:' + data[index].Address + '</div>';
                           var marker = new google.maps.Marker({
                               position: myLatlng,
                               map: map,
                               icon: new google.maps.MarkerImage('images/wifi1.png', undefined, undefined, undefined, new google.maps.Size(20, 20)),
                               animation: google.maps.Animation.G,
                               title: 'Wifi'
                           });
                           showinfomessage(marker, index);
                   ...
                   //   showinfomessage(): add the info windows in each marker and to handle with the mouse click event
        ...
        //call the google API to plan the journey
       function JouneryPlan() {
         
           if (usermarkers.length == 0) {
                    alert("Please select your destiantion in the map, choose the icon in the map!");
                }
                 else
                {
            ...
            <div class="main">
                ...
                ================================================== -->
                    <div class="contact sixteen columns row">
                        <h2 class="separator_title"><span>My Journey</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>Journey Planning</span></h2>
                        &nbsp;<div class="btn_nav" >              
                            <asp:DropDownList ID="DropDownList1" Name="DropDownList1" CssClass="select"  width="35%" runat="server" AutoPostBack="True"  OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" onclick="BacktoMap()" Height="48px"> 
                                <asp:ListItem Value="MyJourney">Select Category</asp:ListItem>  
                                <asp:ListItem Value="Drink Fountain">Drink Fountains</asp:ListItem>  
                                <asp:ListItem Value="Nournishment Hub">Budget Food & Drinks venue</asp:ListItem>
                                ...
                                <asp:ListItem Value="Wifi">Free Wifi</asp:ListItem>          
                            </asp:DropDownList>
                             <div style='float: right;  width: 25%'>
                             <input type="button" id="btn_planJounery" value="Get Directions" onclick="JouneryPlan()" style="position: relative;background: #F0F0F0; height:48px; width:100%; top: -1px; right:25px; padding: 5px;  text-decoration: none; cursor: pointer;font-size:18px; color:#86AE3F" />
                            </div>
                        </div>
